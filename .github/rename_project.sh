...
original_author="MrFengJian"
original_name="byzer_llm_api"
original_urlname="byzer-llm-api"
original_description="Awesome byzer_llm_api created by MrFengJian"
